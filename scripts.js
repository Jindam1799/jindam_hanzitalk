...
introScreen.addEventListener('click', () => {
  ...
  if (bgmAudio.paused && bgmAudio.src) {
    ...
    bgmAudio.play().catch((e) => console.log('BGM 자동재생 차단됨'));
  }
});
...
window.confirmStudyStart = function (difficulty) {
  settingModal.style.display = 'none';
